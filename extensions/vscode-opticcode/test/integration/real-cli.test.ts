...
import { isRecord, validateCapabilitiesReport, validateDoctorReport, validateVersionReport } from '../../src/protocol/validation';
...
describe('real opticcode.exe integration', () => {
  it('validates version and capabilities', async () => {
